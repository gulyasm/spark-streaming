...
public class StreamHelloWindowCount {
    ...
    public static void main(String[] argv) {
        ...
        JavaDStream<String> json = ssc.textFileStream("/home/gulyasm/stream-data/color-value");
        ...
        JavaPairDStream<String, Integer> count = ones.reduceByKeyAndWindow(new Function2<Integer, Integer, Integer>() {
            public Integer call(Integer v1, Integer v2) throws Exception {
                return v1 + v2;
            }
        }, Durations.seconds(50), Durations.seconds(10));
